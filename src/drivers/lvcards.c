...
INPUT_PORTS_START( lvcards )
	...
	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "Red", KEYCODE_N, IP_JOY_NONE )
	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "Black", KEYCODE_M, IP_JOY_NONE )
	

	PORT_START
	PORT_BITX(0x01, IP_ACTIVE_LOW, 0, "Hold 1", KEYCODE_Z, IP_JOY_NONE )
	PORT_BITX(0x02, IP_ACTIVE_LOW, 0, "Hold 2", KEYCODE_X, IP_JOY_NONE )
	PORT_BITX(0x04, IP_ACTIVE_LOW, 0, "Hold 3", KEYCODE_C, IP_JOY_NONE )
	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "Hold 4", KEYCODE_V, IP_JOY_NONE )
	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "Hold 5", KEYCODE_B, IP_JOY_NONE )
