...
INPUT_PORTS_START( mkla1 )
	...
	//There should be an additional block button for player 2 but I couldn't find it
...
GAME( 1992, mkla3,    mk,      mk,       mkla1,   mkla3,    ROT0, "Midway",   "Mortal Kombat (rev 3.0 08/31/92)" )
