...
memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, OFFSET, OFFSET+1, cps2_region_16_r); \
}
...
memory_install_read16_handler(0, ADDRESS_SPACE_PROGRAM, OFFSET, OFFSET+1, cps2_region_16_r2); \
}
