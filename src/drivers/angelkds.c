...
ROM_START( spcpostn )
	...
	ROM_LOAD( "epr10125.c10", 0x00000, 0x08000, CRC(bffd38c6) ) /* encrypted */

	ROM_REGION( 0x28000, REGION_USER1, 0 ) /* Banked Code */
	ROM_LOAD( "epr10120.c1",  0x00000, 0x08000, CRC(d6399f99) )
	ROM_LOAD( "epr10121.c2",  0x08000, 0x08000, CRC(d4861560) )
	ROM_LOAD( "epr10122.c3",  0x10000, 0x08000, CRC(7a1bff1b) )
	ROM_LOAD( "epr10123.c4",  0x18000, 0x08000, CRC(6aed2925) )
	ROM_LOAD( "epr10124.c5",  0x20000, 0x08000, CRC(a1d7ae6b) )

	ROM_REGION( 0x10000, REGION_CPU2, 0 ) /* NEC D780C-1 */
	ROM_LOAD( "epr10126.d4",  0x00000, 0x08000, CRC(ab17f852) )

	/* X090-PC-B 171-5384 */
	ROM_REGION( 0x08000, REGION_GFX1, 0 )
	ROM_LOAD( "epr10133.17",  0x00000, 0x08000, CRC(642e6609) )

	ROM_REGION( 0x10000, REGION_GFX2, 0 )
	ROM_LOAD( "epr10134.18",  0x00000, 0x08000, CRC(c674ff88) )
	ROM_LOAD( "epr10135.19",  0x08000, 0x08000, CRC(0685c4fa) )

	ROM_REGION( 0x30000, REGION_GFX3, 0 )
	ROM_LOAD( "epr10127.06",  0x00000, 0x08000, CRC(b68fcb36) )
	ROM_LOAD( "epr10128.07",  0x08000, 0x08000, CRC(de223817) )
	ROM_LOAD( "epr10129.08",  0x10000, 0x08000, CRC(a6f21023) )
	ROM_LOAD( "epr10130.14",  0x18000, 0x08000, CRC(b68fcb36) )
	ROM_LOAD( "epr10131.15",  0x20000, 0x08000, CRC(de223817) )
	ROM_LOAD( "epr10132.16",  0x28000, 0x08000, CRC(2df8b1bd) )
