...
ROM_START( mjifb )
	...
	ROM_LOAD( "2911.1b",    0x00000, 0x08000, CRC(138a31a1) )
	/* bank switched ROMs follow */
	ROM_CONTINUE(           0x10000, 0x08000 )
	ROM_LOAD( "2902.1c",    0x30000, 0x10000, CRC(0ce02a98) )
	ROM_LOAD( "2903.1d",    0x50000, 0x20000, CRC(90c44965) )
	ROM_LOAD( "2904.1e",    0x70000, 0x20000, CRC(2791abfa) )
	ROM_LOAD( "2905.1f",    0x90000, 0x20000, CRC(b7a73cf7) )
	ROM_LOAD( "2906.1g",    0xb0000, 0x20000, CRC(ad469345) )

	ROM_REGION( 0x400, REGION_PROMS, ROMREGION_DISPOSE )
	ROM_LOAD( "d29-2.4d",   0x000, 0x200, CRC(78252f6a) )
	ROM_LOAD( "d29-1.4c",   0x200, 0x200, CRC(4aaec8cf) )
ROM_END
