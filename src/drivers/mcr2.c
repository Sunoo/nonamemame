...
ROM_START( shtron )
	ROM_REGION( 0x10000, REGION_CPU1, 0 )	/* 64k for code */
	ROM_LOAD( "scpu_pga.bin", 0x0000, 0x2000, CRC(9AEC754C) SHA1(D17A221CEB8AF59D9087AE63A73026C0BD1D58CB) )
	ROM_LOAD( "scpu_pgb.bin", 0x2000, 0x2000, CRC(B99F6FF8) SHA1(575CDBA5BF9965C7765CE913A3376C7BA36B8291) )
	ROM_LOAD( "scpu_pgc.bin", 0x4000, 0x2000, CRC(621AD715) SHA1(8CD34D33C86D10142E0503994A0666AC77C08D4B) )
	ROM_LOAD( "scpu_pgd.bin", 0x6000, 0x2000, CRC(0A64AFB9) SHA1(3AC6660D2B0166C58EC4FECFE37CE36E545064DF) )
	ROM_LOAD( "scpu_pge.bin", 0x8000, 0x2000, CRC(22FA9175) SHA1(FD8EA76B3A7FFAF48FC11DD3B7C58E548E3E57C5) )
	ROM_LOAD( "scpu_pgf.bin", 0xA000, 0x2000, CRC(1716E2BB) SHA1(771E4C20D63E4E1D99723E6355DB67064A278AE5) )

	ROM_REGION( 0x10000, REGION_CPU2, 0 )	/* 64k for the audio CPU */
	ROM_LOAD( "ssi_0a.bin",   0x0000, 0x1000, CRC(9D815BB3) SHA1(51AF797E08DBE3921E11CE70C3D0DA50979336A4) )
	ROM_LOAD( "ssi_0b.bin",   0x1000, 0x1000, CRC(9F253412) SHA1(A526E864073A2F9E67E2CBE53AB17FE726336241) )
	ROM_LOAD( "ssi_0c.bin",   0x2000, 0x1000, CRC(7783D6C6) SHA1(1FB2117532E7DA28AFDB9837BCB6848165CF8173) )

	ROM_REGION( 0x04000, REGION_GFX1, ROMREGION_DISPOSE )
	ROM_LOAD( "scpu_bgg.bin", 0x00000, 0x2000, CRC(3E2B333C) SHA1(B4347D0B3D6149E94DA4A38684C0FAB931E76CC5) )
	ROM_LOAD( "scpu_bgh.bin", 0x02000, 0x2000, CRC(D1D70CC4) SHA1(550E2E8C0BCBF7913B218FE48CD3324622C8D0F4) )

	ROM_REGION( 0x08000, REGION_GFX2, ROMREGION_DISPOSE )
	ROM_LOAD( "vg_3.bin",     0x00000, 0x2000, CRC(33F4554E) SHA1(88DD803158D3C65429B79D2AAF8334130315AA93) )
	ROM_LOAD( "vg_2.bin",     0x02000, 0x2000, CRC(BA1A38B4) SHA1(CEE5F0A66E40C779F1BFBB4BFAFE5301385E7DAE) )
	ROM_LOAD( "vg_1.bin",     0x04000, 0x2000, CRC(6B57F6DA) SHA1(71165DF59DD5CA037116DC0F46FD4F6AAC6DBFD1) )
	ROM_LOAD( "vg_0.bin",     0x06000, 0x2000, CRC(37EA9D07) SHA1(82E006B01EE12390308BE530D4B68FC2404B6B91) )

	ROM_REGION( 0x0100, REGION_PROMS, 0 )
	ROM_LOAD( "82s123.d12",   0x0000, 0x0100, CRC(A9CC86BF) SHA1(BBCEC0570AECEB582FF8238A4BC8546A23430081) )
ROM_END
...
GAME (1998, handiman, 0,        mcr2,    tron,     mcr2,     ROT90, "Bobby Tribble hack", "Handi-Man in Cyberworld")
