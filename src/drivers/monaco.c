...
static void update_player_speed( void )
{
	...
	accel = 0;
	if( keyboard_pressed( KEYCODE_Z ) ) accel = 1;
	if( keyboard_pressed( KEYCODE_X ) ) accel = 2;
	if( keyboard_pressed( KEYCODE_C ) ) accel = 3;
	...
	if( keyboard_pressed( KEYCODE_UP ) )
	{
		gear = 1;
	}
	else if( keyboard_pressed( KEYCODE_DOWN ) )
	{
		gear = 0;
	}
...
static void HandlePlayer( void )
{
	...
	update_player_speed();
	if( keyboard_pressed( KEYCODE_RIGHT ) && sy>0 ) dy-=1.0;
	if( keyboard_pressed( KEYCODE_LEFT ) && sy<SCREEN_HEIGHT-32 ) dy+=1.0;
...
static struct GfxLayout tree_layout =
{
	32,32,
...
static struct GfxLayout pool_layout =
{
	32,32,
	1, /* number of characters */
...
static struct GfxLayout house_layout =
{
	32,32,
	1, /* number of characters */
...
static struct GfxLayout signal_layout =
{
	32,32,
	1, /* number of characters */
	1, /* number of bitplanes */
...
static struct GfxLayout dummy_layout =
{
	32,16,
	2, /* number of characters */
	2, /* number of bitplanes */
...
static struct GfxLayout computer_layout =
{
	32,16,
	2, /* number of characters */
	4, /* number of bitplanes */
...
static struct GfxLayout rescue_layout =
{
	64,16,
	2, /* number of characters */
	4, /* number of bitplanes */
...
static struct GfxLayout explode_layout =
{
	32,32,
	4, /* number of characters */
	1, /* number of bitplanes */
...
static struct GfxLayout bridge_layout =
{
	32,16,
	2, /* number of characters */
	4, /* number of bitplanes */
...
static struct GfxLayout unknown_layout =
{ /* police car? */
	32,32,
	2, /* number of characters */
	1, /* number of bitplanes */
...
static struct GfxLayout tunnel_layout =
{
	32,32,
	2, /* number of characters */
	1, /* number of bitplanes */
...
static struct GfxLayout belt_layout = {
	32,16,
	2, /* number of characters */
	1, /* number of bitplanes */
	{ 4 },
...
static MACHINE_DRIVER_START( monaco )
	...
	MDRV_VISIBLE_AREA(0, SCREEN_WIDTH-1, 0, SCREEN_HEIGHT-1)
	...
	/* sound hardware */
	MDRV_SOUND_ADD(SAMPLES, monaco_samples_interface)
MACHINE_DRIVER_END
