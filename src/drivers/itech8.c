...
INPUT_PORTS_START( stratab )
	...
	PORT_START	/* analog C */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_PLAYER(1)

	PORT_START	/* analog D */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)

	PORT_START	/* analog E */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_COCKTAIL PORT_PLAYER(2)

	PORT_START	/* analog F */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_REVERSE PORT_COCKTAIL PORT_PLAYER(2)
INPUT_PORTS_END
...
INPUT_PORTS_START( sstrike )
	...
	PORT_START	/* analog C */
    PORT_BIT( 0xff, 0x00, IPT_AD_STICK_X ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(50) PORT_KEYDELTA(32) PORT_PLAYER(1)

	PORT_START	/* analog D */
    PORT_BIT( 0xff, 0x00, IPT_AD_STICK_Y ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(50) PORT_KEYDELTA(32) PORT_REVERSE PORT_PLAYER(1)

	PORT_START	/* analog E */
	PORT_BIT( 0xff, 0x60, IPT_PADDLE ) PORT_MINMAX(0x28,0x98) PORT_SENSITIVITY(100) PORT_KEYDELTA(1) PORT_PLAYER(2)

	UNUSED_ANALOG	/* analog F */

	PORT_START	/* fake "shoot" port */
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON3 ) PORT_NAME("Roll")
INPUT_PORTS_END
...
INPUT_PORTS_START( gtgt )
	...
	PORT_START	/* analog C */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_PLAYER(1)

	PORT_START	/* analog D */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_REVERSE PORT_PLAYER(1)
...
INPUT_PORTS_START( gtg2 )
	...
	PORT_START	/* analog E */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_X ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_COCKTAIL PORT_PLAYER(2)

	PORT_START	/* analog F */
    PORT_BIT( 0xff, 0x00, IPT_TRACKBALL_Y ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(25) PORT_KEYDELTA(32) PORT_CENTER PORT_REVERSE PORT_COCKTAIL PORT_PLAYER(2)
INPUT_PORTS_END
...
INPUT_PORTS_START( slikshot )
	...
	PORT_START	/* fake "shoot" port */
	PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON4 ) PORT_NAME("Shoot")
INPUT_PORTS_END
...
INPUT_PORTS_START( pegglet )
	...
	PORT_START		/* analog D */
	PORT_BIT( 0xff, 0x00, IPT_DIAL ) PORT_MINMAX(0x80,0x7f) PORT_SENSITIVITY(50) PORT_KEYDELTA(10) PORT_CENTER PORT_PLAYER(1)
...
INPUT_PORTS_START( rimrockn )
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("P3 Shoot") PORT_PLAYER(3)
	...
	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 ) PORT_NAME("P4 Shoot") PORT_PLAYER(4)
...
GAME ( 1989, gtgt,     gtg,      tmshi2203, gtgt,     0,        ROT0,   "Strata/Incredible Technologies", "Golden Tee Golf (Trackball, v1.0)" )
