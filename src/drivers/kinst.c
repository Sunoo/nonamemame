...
static ADDRESS_MAP_START( main_readmem, ADDRESS_SPACE_PROGRAM, 32 )
	...
	AM_RANGE(0x00000000, 0x00000fff) AM_READ(MRA32_BANK4)
	AM_RANGE(0x00001000, 0x0007ffff) AM_READ(MRA32_BANK1)	/* -> rambase1 + 0x1000 */
	AM_RANGE(0x80000000, 0x8007ffff) AM_READ(MRA32_RAM)
	AM_RANGE(0x88000000, 0x887fffff) AM_READ(MRA32_RAM)
	AM_RANGE(0x9fc00000, 0x9fc7ffff) AM_READ(MRA32_BANK2)	/* -> rombase */
	AM_RANGE(0xa0000000, 0xa007ffff) AM_READ(MRA32_BANK3)	/* -> rambase1 */
	AM_RANGE(0xb0000080, 0xb00000ff) AM_READ(kinst_control_r)
	AM_RANGE(0xb0000100, 0xb000013f) AM_READ(ide_controller_r)
	AM_RANGE(0xb0000170, 0xb0000173) AM_READ(ide_controller_extra_r)
	AM_RANGE(0xbfc00000, 0xbfc7ffff) AM_READ(MRA32_ROM)
ADDRESS_MAP_END


static ADDRESS_MAP_START( main_writemem, ADDRESS_SPACE_PROGRAM, 32 )
	AM_RANGE(0x00000000, 0x00000fff) AM_WRITE(MWA32_BANK4)
	AM_RANGE(0x00001000, 0x0007ffff) AM_WRITE(MWA32_BANK1)
	AM_RANGE(0x80000000, 0x8007ffff) AM_WRITE(MWA32_RAM) AM_BASE(&rambase1)
	AM_RANGE(0x88000000, 0x887fffff) AM_WRITE(MWA32_RAM) AM_BASE(&rambase2)
	AM_RANGE(0x9fc00000, 0x9fc7ffff) AM_WRITE(MWA32_ROM)
	AM_RANGE(0xa0000000, 0xa007ffff) AM_WRITE(MWA32_BANK3)
	AM_RANGE(0xb0000080, 0xb00000ff) AM_WRITE(kinst_control_w) AM_BASE(&kinst_control)
	AM_RANGE(0xb0000100, 0xb000013f) AM_WRITE(ide_controller_w)
	AM_RANGE(0xb0000170, 0xb0000173) AM_WRITE(ide_controller_extra_w)
	AM_RANGE(0xbfc00000, 0xbfc7ffff) AM_WRITE(MWA32_ROM) AM_BASE(&rombase)
ADDRESS_MAP_END
