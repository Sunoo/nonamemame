...
static ADDRESS_MAP_START( main_readmem, ADDRESS_SPACE_PROGRAM, 16 )
	...
	/* <jake> */
	AM_RANGE(0x6c0000, 0x6c0001) AM_READ(input_ports_2_and_6_word_r)
	AM_RANGE(0x6c0002, 0x6c0003) AM_READ(input_ports_3_and_7_word_r)
...
/* <jake> */
	// Fake input ports for player 3's trackball
	PORT_START
    PORT_BIT( 0x00ff, 0, IPT_TRACKBALL_Y ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_REVERSE PORT_PLAYER(3)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )

	PORT_START
    PORT_BIT( 0x00ff, 0, IPT_TRACKBALL_X ) PORT_MINMAX(0,0) PORT_SENSITIVITY(100) PORT_KEYDELTA(30) PORT_REVERSE PORT_PLAYER(3)
	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED )
/* </jake> */
INPUT_PORTS_END
