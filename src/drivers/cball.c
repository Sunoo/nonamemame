...
ROM_START( cballfix )
	...
	ROM_REGION( 0x0200, REGION_GFX1, ROMREGION_DISPOSE ) /* tiles */
	ROM_LOAD_NIB_LOW ( "canball.6m", 0x0000, 0x0200, CRC(357CC660) SHA1(EA90BF0C62CC41A13CE42D10A09363C19B4DEF23) )
	ROM_LOAD_NIB_HIGH( "canball.6l", 0x0000, 0x0200, CRC(5b1c9e88) SHA1(6e9630db9907170c53942a21302bcf8b721590a3) ) 
...
GAMEX( 1976, cballfix, cball, cball, cball, 0, ROT0, "Atari / MASH", "Cannonball (Missing ROM recreated)", GAME_NO_SOUND )
